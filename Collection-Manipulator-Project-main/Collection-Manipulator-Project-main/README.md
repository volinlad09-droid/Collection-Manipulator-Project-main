...
**01 — Data Storage**
Learn how different collection types can store different kinds of information.

**02 — Data Manipulation**
Add, modify, and remove records dynamically.

**03 — Data Organization**
Use dictionaries and lists to organize student information.

**04 — Uniqueness**
Use sets to maintain unique subject names.

**05 — Program Logic**
Build a complete menu-driven application using loops and conditions.
